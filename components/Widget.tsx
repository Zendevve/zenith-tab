  ...
  return (
    <div className="group/widget relative h-full flex flex-col transition-all duration-300 rounded-xl hover:bg-white/[0.03] border border-transparent hover:border-white/5">
      ...
      <div className="flex-grow flex flex-col overflow-hidden p-6">
        <div className="text-[10px] uppercase tracking-[0.2em] text-white/30 mb-4 select-none">
          {title}
        </div>
        <div className="flex-grow overflow-y-auto scrollbar-hide text-[var(--fg-color)] relative">
          {children}
        </div>
      </div>
    </div>
